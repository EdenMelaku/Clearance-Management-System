...
public class FilterForActivateClearanceServlet extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response) {
        user u;
        String username = null;
        try {
            StudentBean[] students = FilterStudents.toActivate();
            ...
            JOptionPane.showMessageDialog(null, username+" "+students.length);
