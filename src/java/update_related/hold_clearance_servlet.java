...
public class hold_clearance_servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            try {
                ...
                getServletContext().getRequestDispatcher("/ActivateStudent.jsp").forward(request, response);
                ...
                try {
                    ...
                    Logger.getLogger(hold_clearance_servlet.class.getName()).log(Level.SEVERE, null, ex1);
                } catch (IOException ex1) {
                    Logger.getLogger(hold_clearance_servlet.class.getName()).log(Level.SEVERE, null, ex1);
                }
            } catch (ServletException ex) {
                Logger.getLogger(hold_clearance_servlet.class.getName()).log(Level.SEVERE, null, ex);
