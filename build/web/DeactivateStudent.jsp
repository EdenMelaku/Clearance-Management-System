...
<html>
    ...
    <body style = "background-color:#DFE2DB;color:black;">
        ...
        <form name="myform" class="student_table" id="tt" method="post" action="ActivateClearanceServlet" >            &nbsp;&nbsp;&nbsp;&nbsp;
            <div id="msgSuc">
                ${msgSuccess}
            </div>
            <div id="msgF">
            ...
            <table class="testTable">  
                <thead id="head">
                    <tr>
                        ...
                        <td>
                            <a href="FilterForDeactivateClearanceServlet?username=<%=bean.getUsername()%>" class="refreshLink">Refresh</a>
                        </td>
                    </tr>
                    <tr>
                        <th>ID</th>
