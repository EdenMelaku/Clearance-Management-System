...
<html>
    ...
    <body style = "background-color:#DFE2DB;color:black;">
        ...
        <form name="myform" class="student_table" id="tt" method="post" action="approveClearanceServlet" >
            &nbsp;&nbsp;&nbsp;&nbsp;
            <table class="testTable">     
                ...
                <tr>
                    ...
                    <td>
                        <a href="ApproveClearanceFilterServlet?username=<%=bean.getUsername()%>"class="refreshLink">Refresh</a>
                    </td>
                </tr>
                <tr>
                    <th>ID</th>
